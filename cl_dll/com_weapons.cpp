...
=====================
*/
void HUD_SendWeaponAnim( int iAnim, float flFramerate, byte byFrame, int force )
{
	...
	gEngfuncs.pfnWeaponAnim( iAnim, flFramerate, byFrame, force );
}
...
void HUD_PlaybackEvent(int flags, const edict_t* pInvoker, unsigned short eventindex, float delay,
	float* origin, float* angles, float fparam1, float fparam2, int iparam1, int iparam2, int bparam1, int bparam2, float* vparam1, float* vparam2,
	int aparam1, float aparam2, byte aparam3)
{
	vec3_t org;
	vec3_t ang;
	...
	ang = v_angles;
	gEngfuncs.pfnPlaybackEvent(flags, pInvoker, eventindex, delay, (float*)&org, (float*)&ang, fparam1, fparam2, iparam1, iparam2, bparam1, bparam2, (float*)&vparam1, (float*)&vparam2, aparam1, aparam2, aparam3);
}
