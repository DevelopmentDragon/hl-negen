...
const Vector g_vecDummy = Vector(0, 0.01, 0);
...
// CBaseEntity Stubs
int CBaseEntity :: TakeHealth( float flHealth, int iDamageId ) { return 1; }
int CBaseEntity :: TakeDamage( entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int iDamageId ) { return 1; }
...
void CBaseEntity::TraceAttack(entvars_t *pevAttacker, float flDamage, Vector vecDir, TraceResult *ptr, int iDamageId) { }
void CBaseEntity :: TraceBleed( float flDamage, Vector vecDir, TraceResult *ptr, int iDamageId ) { }
...
void CBaseMonster :: TraceAttack( entvars_t *pevAttacker, float flDamage, Vector vecDir, TraceResult *ptr, int iDamageId) { }
...
void CBaseMonster :: RadiusDamage(entvars_t* pevInflictor, entvars_t*	pevAttacker, float flDamage, int iClassIgnore, int iDamageId ) { }
void CBaseMonster :: RadiusDamage( Vector vecSrc, entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int iClassIgnore, int iDamageId ) { }
void CBaseMonster::RadiusDamage2(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int iClassIgnore, float flRadius, int iDamageId) { }
void CBaseMonster::RadiusDamage2(Vector vecSrc, entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int iClassIgnore, float flRadius, int iDamageId) { }
...
int CBaseMonster :: TakeHealth (float flHealth, int iDamageId) { return 0; }
...
int CBasePlayer :: TakeHealth( float flHealth, int iDamageId ) { return 0; }
void CBasePlayer :: TraceAttack( entvars_t *pevAttacker, float flDamage, Vector vecDir, TraceResult *ptr, int iDamageId) { }
int CBasePlayer :: TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int iDamageId ) { return 0; }
...
int CBasePlayer::RemovePlayerItemAlt(CBasePlayerItem* pItem) { return FALSE; }
...
BOOL CBasePlayer::SwitchWeaponAlt(CBasePlayerItem* pWeapon) { return FALSE; }
...
int DamageDecal( CBaseEntity *pEntity, int iDamageId ) { return 0; }
...
void RadiusDamage( Vector vecSrc, entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, float flRadius, int iClassIgnore, int iDamageId ){}

void CBasePlayerItem::UpdateSpot(void) { return; };
void CBasePlayerItem::ActivateSpot(void) { return; };
void CBasePlayerItem::DeactivateSpot(void) { return; };
void CBasePlayerItem::SuspendSpot(float flTime) { return; };
float CBasePlayerItem::GetSpotRender(void) { return 0.0f; };
float CBasePlayerItem::SetDotRenderTime(float flTime) { return 0.0f; };
BOOL CBasePlayerItem::SpotEnabled(void) { return FALSE; };

int CBasePlayerItem::GetNumClips(void) { return 0; };
void CBasePlayerItem::SetChamberedRounds(int iClipIndex, int iAmount) { return; };
void CBasePlayerItem::IncrementChamberedRounds(int iClipIndex, int iAmount) { return; };
void CBasePlayerItem::DecrementChamberedRounds(int iClipIndex, int iAmount) { return; };
void CBasePlayerItem::SetMaxChamberedRounds(int iClipIndex, int iAmount) { return; };
int CBasePlayerItem::GetNumAmmoTypes(void) { return 0; };
BOOL CBasePlayerItem::ValidAmmoTypeIndex(int iAmmoTypeIndex) { return FALSE; };
int CBasePlayerItem::GetNumAltAmmoTypes(int iAmmoTypeIndex) { return 0; }
BOOL CBasePlayerItem::ValidAltAmmoTypeIndex(int iAmmoTypeIndex, int iAmmoAltTypeIndex) { return FALSE; };
int CBasePlayerItem::GetTotalNumAmmoTypes(void) { return 0; };
BOOL CBasePlayerItem::ValidClipIndex(int iClipIndex) { return FALSE; };
int CBasePlayerItem::GetClipAmmoLegalIndex(int iClipIndex) { return -1; };
int CBasePlayerItem::GetClipAmmoIndex(int iClipIndex) { return -1; };
int CBasePlayerItem::GetCurrentAmmoType(int iAmmoTypeIndex) { return -1; };
int CBasePlayerItem::GetClip(int iClipIndex) { return -2; };
int CBasePlayerItem::GetMaxClip(int iClipIndex) { return -2; };
int CBasePlayerItem::GetChamberedRounds(int iClipIndex) { return -1; };
BOOL CBasePlayerItem::UsesAmmo(void) { return FALSE; };
BOOL CBasePlayerItem::UsesAmmoIndex(int iAmmoIndex) { return FALSE; };
BOOL CBasePlayerItem::UsesAmmoName(const char* szAmmoName) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteReserveAmmoCheat(flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteReserveAmmo(flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasReserveAmmo(flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteReserveAmmoIndex(int iAmmoIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasReserveAmmoIndex(int iAmmoIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteReserveAmmoType(int iAmmoTypeIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasReserveAmmoType(int iAmmoTypeIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteReserveAmmoName(const char* szAmmoName, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasReserveAmmoName(const char* szAmmoName, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteClipAmmoCheat(flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteClipAmmoIndex(int iAmmoType, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteClipAmmoTypeIndex(int iAmmoType, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteClipAmmo(flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasClipAmmo(flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasClipAmmoIndex(int iClipIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasClipAmmoTypeIndex(int iClipIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteClipAmmoIndexSpecific(int iClipIndex, int iAmmoIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasClipAmmoIndexSpecific(int iClipIndex, int iAmmoIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasInfiniteClipAmmoIndexArray(int iAmmoIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasClipAmmoIndexArray(int iAmmoIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
void CBasePlayerItem::SetClip(int iClipIndex, int iAmount) { return; };
void CBasePlayerItem::SetMaxClip(int iClipIndex, int iAmount) { return; };
int CBasePlayerItem::GetMaxChamberedRounds(int iClipIndex) { return 0; };
BOOL CBasePlayerItem::HasAmmo(flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasAmmoType(int iAmmoType, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasAmmoIndex(int iAmmoIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBasePlayerItem::HasAmmoName(const char* szAmmoName, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
int CBasePlayerItem::GetAmmoTypeMinBound(int iAmmoTypeIndex) { return -1; };
int CBasePlayerItem::GetAmmoTypeMaxBound(int iAmmoTypeIndex) { return -1; };
int CBasePlayerItem::GetClipAmmoType(int iClipIndex) { return -1; };
int CBasePlayerItem::GetPreReloadClip(int iClipIndex) { return -1; };
void CBasePlayerItem::SetPreReloadClip(int iClipIndex, int iAmount) { return; };
int CBasePlayerItem::GetTargetAmmoIndex(int iAmmoTypeIndex) { return -1; };
void CBasePlayerItem::SetTargetAmmoIndex(int iAmmoTypeIndex, int iTargetAmmoTypeIndex) { return; };
void CBasePlayerItem::SetCurrentAmmoType(int iAmmoTypeIndex, int iSetTo) { return; };

BOOL CBaseEntity::PureHasPositiveAmmoIndex(int iAmmoIndex) { return FALSE; };
BOOL CBaseEntity::PureHasInfiniteAmmoIndex(int iAmmoIndex) { return FALSE; };
BOOL CBaseEntity::PureHasAmmoIndex(int iAmmoIndex) { return FALSE; };
BOOL CBaseEntity::HasAmmo(flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBaseEntity::HasAmmoIndex(int iAmmoIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBaseEntity::HasAmmoName(const char* szAmmoName, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBaseEntity::HasInfiniteAmmoCheat(flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBaseEntity::HasInfiniteAmmo(flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBaseEntity::HasInfiniteAmmoIndex(int iAmmoIndex, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };
BOOL CBaseEntity::HasInfiniteAmmoName(const char* szAmmoName, flag fCheckFlags = AMMO_CHECK_DEFAULT_PARAMS) { return FALSE; };

void CBasePlayerWeapon::ReloadStart(void) { return; };
void CBasePlayerWeapon::ReloadStartToMid(void) { return; };
void CBasePlayerWeapon::ReloadMid(void) { return; };
void CBasePlayerWeapon::ReloadMidToEnd(void) { return; };
void CBasePlayerWeapon::ReloadEnd(void) { return; };
void CBasePlayerWeapon::ReloadEndToStart(void) { return; };
void CBasePlayerWeapon::ReloadCheck(void) { return; };

BOOL CBasePlayerItem::CanDuplicate(CBasePlayerItem* pOriginal) { return FALSE; };
...
BOOL HasFlags(int fOriginal, int fFlags, int iCheckType)
{
	...
	case FC_ONLY:
		bResult = (fOriginal == fFlags);
		break;

	case FC_ALL:
	default:
		bResult = ((fOriginal & fFlags) == fFlags);
		break;
	}
...
// Set or unset flags depending on 
void SetFlags(int& fOriginal, int fFlags, BOOL bSwitch)
{
	if (bSwitch)
		fOriginal |= fFlags;
	else
...
// Check if varriable has or doesn't have the flags
BOOL HasFlags64(flag fOriginal, flag fFlags, int iCheckType)
{
	BOOL bResult = FALSE;
...
// Set or unset flags depending on 
void SetFlags64(flag& fOriginal, flag fFlags, BOOL bSwitch)
{
	if (bSwitch)
		fOriginal |= fFlags;
	else
