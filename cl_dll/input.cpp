...
kbutton_t	in_attack4;
kbutton_t	in_attack5;
kbutton_t	in_up;
kbutton_t	in_down;
kbutton_t	in_duck;
kbutton_t	in_reload;
...
// ATTACK4
void IN_Attack4Down(void)
{
	KeyDown(&in_attack4);

	gHUD.m_Spectator.HandleButtonsDown(IN_ATTACK4);
}

void IN_Attack4Up(void) { KeyUp(&in_attack4); }

// ATTACK5
void IN_Attack5Down(void)
{
	KeyDown(&in_attack5);

	gHUD.m_Spectator.HandleButtonsDown(IN_ATTACK5);
}

void IN_Attack5Up(void) { KeyUp(&in_attack5); }
...
int CL_ButtonBits( int bResetState )
{
	...
	if (in_attack4.state & 3)
	{
		bits |= IN_ATTACK4;
	}

	if (in_attack5.state & 3)
	{
		bits |= IN_ATTACK5;
	}
...
void InitInput (void)
{
	...
	gEngfuncs.pfnAddCommand("+attack4", IN_Attack4Down);
	gEngfuncs.pfnAddCommand("-attack4", IN_Attack4Up);
	gEngfuncs.pfnAddCommand("+attack5", IN_Attack5Down);
	gEngfuncs.pfnAddCommand("-attack5", IN_Attack5Up);
