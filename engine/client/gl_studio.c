...
void R_DrawViewModel( void )
{
	...
	// Render arm model only if detected
	if (RI.currententity->curstate.armmodel)
	{
		RI.currententity->curstate.body = RI.currententity->curstate.armmodelbody;
		RI.currententity->curstate.skin = RI.currententity->curstate.armmodelskin;
		...
		cl_entity_t	saveent = *RI.currententity;
		model_t* pweaponmodel = CL_ModelHandle(RI.currententity->curstate.armmodel);
