...
#define MAX_DEMOS		32
#define MAX_MOVIES		8
#define MAX_CLIENT_SPRITES	512 // OLD: 256	// SpriteTextures
...
void CL_PlaybackEvent(int flags, const edict_t* pInvoker, word eventindex, float delay, float* origin,
	float* angles, float fparam1, float fparam2, int iparam1, int iparam2, int bparam1, int bparam2, float* vparam1, float* vparam2, int aparam1, float aparam2, byte aparam3);
...
void CL_WeaponAnim( int iAnim, float flFramerate, byte byFrame );
...
void S_StartBackgroundTrack( const char *intro, const char *loop, long position, int loopCount, qboolean onLoop, qboolean restored, qboolean fullpath );
