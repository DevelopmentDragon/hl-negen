...
void CL_PrepareTEnt( TEMPENTITY *pTemp, model_t *pmodel )
{
	...
	pTemp->entity.curstate.viewmodelbody = 0;
	pTemp->entity.curstate.armmodelbody = 0;
	pTemp->entity.curstate.playmodelbody = 0;
	pTemp->entity.curstate.viewmodelskin = 0;
	pTemp->entity.curstate.armmodelskin = 0;
	pTemp->entity.curstate.playmodelskin = 0;
