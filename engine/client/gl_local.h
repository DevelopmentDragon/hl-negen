...
//
// gl_downsample.c // FarEast: Included support of down sampling, thanks to Magic Nipples
//
...
void R_DrawStretchPicCircleRotate(float x, float y, float radius, int numshapes, int type, float thickness, int texnum, float xscale, float yscale, float selfangle, float angle, float xpivot, float ypivot);
...
// FarEast: Included support of down sampling, thanks to Magic Nipples
