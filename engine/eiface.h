...
typedef struct enginefuncs_s
{
	...
	void	(*pfnPlaybackEvent)(int flags, const edict_t* pInvoker, unsigned short eventindex, float delay, float* origin, float* angles, float fparam1, float fparam2, int iparam1, int iparam2, int bparam1, int bparam2, float* vparam1, float* vparam2, int aparam1, float aparam2, byte aparam3);
