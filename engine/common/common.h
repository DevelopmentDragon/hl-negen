...
typedef struct
{
	...
	int		body;		// curstate.body
	int		skin;		// curstate.skin
...
typedef struct host_parm_s
{
	...
	int				infinite_ammo; // FarEast: Infinite Ammo cheat
...
void SV_StartMusic( const char *curtrack, const char *looptrack, long position, int loopNum, int onLoop, int restored );
