...
#define range(x, a, b) ( (a == b) ? (x == a || x == b) : ((a > b) ? (x <= a && x >= b) : (x >= a && x <= b)) )
#define rangexa(x, a, b) ( (a == b) ? (x == b) : ((a > b) ? (x < a && x >= b) : (x > a && x <= b)) )
#define rangexb(x, a, b) ( (a == b) ? (x == a) : ((a > b) ? (x <= a && x > b) : (x >= a && x < b)) )
#define rangex(x, a, b) ( (a == b) ? ((x != a) : ((a > b) ? (x < a && x > b) : (x > a && x < b)) )
