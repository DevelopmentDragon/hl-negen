...
extern convar_t		sv_skyspeed; // FarEast: Rotating Skybox added back in
extern convar_t		sv_skyangle; // FarEast: Rotating Skybox added back in
extern convar_t		sv_skydir_x;
extern convar_t		sv_skydir_y;
extern convar_t		sv_skydir_z;
