...
CVAR_DEFINE_AUTO(sv_infinite_ammo, "0", FCVAR_SERVER, "Allow infinite ammo on weapons, 1 for reserve, 2 for ammo1, 4 for ammo2, 8 for clip ammo, 16 for override children");
...
CVAR_DEFINE_AUTO( skill, "2", 0, "skill level in singleplayer game" );
...
void SV_Init( void )
{
	...
	Cvar_RegisterVariable(&sv_infinite_ammo);
