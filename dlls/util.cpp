...
TYPEDESCRIPTION	gEntvarsDescription[] = 
{
	...
	DEFINE_ENTITY_FIELD(armmodel, FIELD_MODELNAME),
	DEFINE_ENTITY_FIELD(viewmodelbody, FIELD_INTEGER),
	DEFINE_ENTITY_FIELD(armmodelbody, FIELD_INTEGER),
	DEFINE_ENTITY_FIELD(playmodelbody, FIELD_INTEGER),
	DEFINE_ENTITY_FIELD(viewmodelskin, FIELD_INTEGER),
	DEFINE_ENTITY_FIELD(armmodelskin, FIELD_INTEGER),
	DEFINE_ENTITY_FIELD(playmodelskin, FIELD_INTEGER),

	DEFINE_ENTITY_FIELD(savedvanim, FIELD_INTEGER),
	DEFINE_ENTITY_FIELD(savedvframerate, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(savedvframe, FIELD_FLOAT),
	...
	DEFINE_ENTITY_FIELD(health_type, FIELD_INTEGER),
	DEFINE_ENTITY_FIELD(health_max, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(health_over_max, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(health_temp, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(health_temp_max, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(armor, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(armor_type, FIELD_INTEGER),
	DEFINE_ENTITY_FIELD(armor_max, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(armor_over_max, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(armor_temp, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(armor_temp_max, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(shield, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(shield_type, FIELD_INTEGER),
	DEFINE_ENTITY_FIELD(shield_max, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(shield_over_max, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(shield_temp, FIELD_FLOAT),
	DEFINE_ENTITY_FIELD(shield_temp_max, FIELD_FLOAT),
...
void CSave::WriteFlag(const char* pname, const flag* data, int count)
{
	BufferField(pname, sizeof(flag) * count, (const char*)data);
}
...
void EntvarsKeyvalue( entvars_t *pev, KeyValueData *pkvd )
{
	...
	for ( i = 0; i < ENTVARS_COUNT; i++ )
	{
		...
		if ( !stricmp( pField->fieldName, pkvd->szKeyName ) )
		{
			...
			case FIELD_FLAG:
				(*(flag*)((char*)pev + pField->fieldOffset)) = (flag)atoll(pkvd->szValue);
				break;
...
int CSave :: WriteFields( const char *pname, void *pBaseData, TYPEDESCRIPTION *pFields, int fieldCount )
{
	...
	for ( i = 0; i < fieldCount; i++ )
	{
		...
		case FIELD_FLAG:
			WriteFlag(pTest->fieldName, (flag*)pOutputData, pTest->fieldSize);
		break;
		...
		if ( !stricmp( pTest->fieldName, pName ) )
		{
			if ( !m_global || !(pTest->flags & FTYPEDESC_GLOBAL) )
			{
				for ( j = 0; j < pTest->fieldSize; j++ )
				{
					...
					case FIELD_FLAG:
						*((flag*)pOutputData) = *(flag*)pInputData;
					break;
