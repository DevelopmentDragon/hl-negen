...
// TraceAttack
//=========================================================
void CAGrunt :: TraceAttack( entvars_t *pevAttacker, float flDamage, Vector vecDir, TraceResult *ptr, int iDamageId)
{
	// Add exceptions to what hits this
	if ( ptr->iHitgroup == 10)
	{
		// hit armor
...
void CAGrunt :: HandleAnimEvent( MonsterEvent_t *pEvent )
{
	...
	case AGRUNT_AE_LEFT_PUNCH:
		{
			CBaseEntity *pHurt = CheckTraceHullAttack( AGRUNT_MELEE_DIST, gSkillData.agruntDmgPunch, ID_DMG_AGRUNT_SMASH );
