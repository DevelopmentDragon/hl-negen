...
//
//	if (m_hOwner != NULL)
//		RadiusDamage(pev, m_hOwner->pev, pev->dmg, CLASS_NONE, ID_DMG_SNARK_BLAST);
//	else
//		RadiusDamage(pev, pev, pev->dmg, CLASS_NONE, ID_DMG_SNARK_BLAST);
//
...
////				ClearMultiDamage( );
//				pOther->TraceAttack(pev, gSkillData.snarkDmgBite, gpGlobals->v_forward, &tr, ID_DMG_SNARK_BITE);
//
//				/*
//				if (m_hOwner != NULL)
//					ApplyMultiDamage( pev, m_hOwner->pev, ID_DMG_SNARK_BITE );
//				else
//					ApplyMultiDamage( pev, pev, ID_DMG_SNARK_BITE );
//					*/
//
...
//}
//
//int CSqueak::HUDIcon(void)
//{
//	return 111;
//}
//
//int CSqueak::HUDActiveIcon(void)
//{
//	return 112;
//}
//
//int CSqueak::ModeIcon(void)
//{
//	return -1;
//}
//
//int CSqueak::ModeIcon2(void)
//{
//	return -1;
//}
//
//int CSqueak::ModeIcon3(void)
//{
//	return -1;
//}
//
//int CSqueak::SmallIcon(void)
//{
//	return 62;
//}
//
...
//	{
//		m_pPlayer->pev->weapons[WEAPON_SNARK / 32] &= ~(1 << (WEAPON_SNARK % 32));
...
//#endif
//
//		int iAnim = m_pPlayer->pev->savedvanim = SQUEAK_THROW;
//		float flFramerate = m_pPlayer->pev->savedvframerate = 1.0f;
//		byte byFrame = m_pPlayer->pev->savedvframe = (byte)0;
//		PLAYBACK_EVENT_FULL(flags, m_pPlayer->edict(), m_usSnarkFire, 0.0, (float*)&g_vecZero, (float*)&g_vecZero, 0.0, 0.0,
//			0, 0, 0, 0, (float*)&g_vecZero, (float*)&g_vecZero, iAnim, flFramerate, byFrame);
//
...
//		m_flNextWeaponIdle = UTIL_WeaponTimeBase() + 70.0 / 16.0;
//	}
//	else
//	{
//		iAnim = SQUEAK_FIDGETNIP;
//		m_flNextWeaponIdle = UTIL_WeaponTimeBase() + 80.0 / 16.0;
//	}
