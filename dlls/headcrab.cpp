...
void CHeadCrab :: LeapTouch ( CBaseEntity *pOther )
{
	...
	if ( !FBitSet( pev->flags, FL_ONGROUND ) )
	{
		...
		pOther->TakeDamage( pev, pev, GetDamageAmount(), ID_DMG_HEADCRAB_LUNGE );
	}
...
int CHeadCrab :: TakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int iDamageId )
{
