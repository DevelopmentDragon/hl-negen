...
void CFuncRotating :: HurtTouch ( CBaseEntity *pOther )
{
	...
	pOther->TakeDamage( pev, pev, pev->dmg, ID_DMG_FUNC_ROTATE_TOUCH );
...
{
	pOther->TakeDamage( pev, pev, pev->dmg, ID_DMG_FUNC_ROTATE_BLOCK );
}
...
void CPendulum :: Touch ( CBaseEntity *pOther )
{
	...
	pOther->TakeDamage( pev, pev, damage, ID_DMG_FUNC_PENDULUM_TOUCH );
