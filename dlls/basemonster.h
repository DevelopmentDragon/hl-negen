...
// stuff written for new state machine
	...
	int			DeadTakeDamage( entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int iDamageId );

	void RadiusDamage(entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int iClassIgnore, int iDamageId );
	void RadiusDamage(Vector vecSrc, entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, int iClassIgnore, int iDamageId );
	void RadiusDamage2(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int iClassIgnore, float flRadius, int iDamageId);
	void RadiusDamage2(Vector vecSrc, entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int iClassIgnore, float flRadius, int iDamageId);
