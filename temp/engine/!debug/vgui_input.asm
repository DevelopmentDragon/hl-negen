; Listing generated by Microsoft (R) Optimizing Compiler Version 19.37.32705.0 
	...
	TITLE	D:\DevDragon\XashFE\dev\src\temp\engine\!debug\vgui_input.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?VGUI_InitCursors@@YAXXZ			; VGUI_InitCursors
PUBLIC	?VGUI_CursorSelect@@YAXPAVCursor@vgui@@@Z	; VGUI_CursorSelect
PUBLIC	?VGUI_ActivateCurrentCursor@@YAXXZ		; VGUI_ActivateCurrentCursor
PUBLIC	?VGUI_InitKeyTranslationTable@@YAXXZ		; VGUI_InitKeyTranslationTable
PUBLIC	?VGUI_MapKey@@YA?AW4KeyCode@vgui@@H@Z		; VGUI_MapKey
...
PUBLIC	?__LINE__Var@?0??VGUI_CursorSelect@@YAXPAVCursor@vgui@@@Z@4JA ; `VGUI_CursorSelect'::`1'::__LINE__Var
PUBLIC	??_C@_0DO@BHDILELM@D?3?2DevDragon?2XashFE?2dev?2src?2eng@ ; `string'
PUBLIC	??_C@_0P@OKCGOPOA@cursor?5?$CB?$DN?5NULL@	; `string'
PUBLIC	??_C@_01GBGANLPD@0@				; `string'
PUBLIC	?__LINE__Var@?0??VGUI_MapKey@@YA?AW4KeyCode@vgui@@H@Z@4JA ; `VGUI_MapKey'::`1'::__LINE__Var
...
EXTRN	_cl:BYTE
EXTRN	_cls:BYTE
EXTRN	?engSurface@@3PAVCEngineSurface@@A:DWORD	; engSurface
EXTRN	?engApp@@3PAVCEngineApp@@A:DWORD		; engApp
EXTRN	??_7type_info@@6B@:QWORD			; type_info::`vftable'
_BSS	SEGMENT
?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A DD 0100H DUP (?) ; s_pVirtualKeyTrans
?s_pDefaultCursor@@3PAPAUHICON__@@A DD 014H DUP (?)	; s_pDefaultCursor
?s_hCurrentCursor@@3PAUHICON__@@A DD 01H DUP (?)	; s_hCurrentCursor
?bInitted@?1??VGUI_InitKeyTranslationTable@@YAXXZ@4_NA DB 01H DUP (?) ; `VGUI_InitKeyTranslationTable'::`2'::bInitted
_BSS	ENDS
...
??_R4SurfaceBase@vgui@@6B@ DD 00H			; vgui::SurfaceBase::`RTTI Complete Object Locator'
	...
	DD	FLAT:??_R3SurfaceBase@vgui@@8
rdata$r	ENDS
;	COMDAT ?__LINE__Var@?0??VGUI_MapKey@@YA?AW4KeyCode@vgui@@H@Z@4JA
_DATA	SEGMENT
?__LINE__Var@?0??VGUI_MapKey@@YA?AW4KeyCode@vgui@@H@Z@4JA DD 0d9H ; `VGUI_MapKey'::`1'::__LINE__Var
_DATA	ENDS
;	COMDAT ??_C@_01GBGANLPD@0@
CONST	SEGMENT
??_C@_01GBGANLPD@0@ DB '0', 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@OKCGOPOA@cursor?5?$CB?$DN?5NULL@
CONST	SEGMENT
??_C@_0P@OKCGOPOA@cursor?5?$CB?$DN?5NULL@ DB 'cursor != NULL', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0DO@BHDILELM@D?3?2DevDragon?2XashFE?2dev?2src?2eng@
CONST	SEGMENT
??_C@_0DO@BHDILELM@D?3?2DevDragon?2XashFE?2dev?2src?2eng@ DB 'D:\DevDrago'
	DB	'n\XashFE\dev\src\engine\client\vgui\vgui_input.cpp', 00H ; `string'
CONST	ENDS
;	COMDAT ?__LINE__Var@?0??VGUI_CursorSelect@@YAXPAVCursor@vgui@@@Z@4JA
_DATA	SEGMENT
?__LINE__Var@?0??VGUI_CursorSelect@@YAXPAVCursor@vgui@@@Z@4JA DD 032H ; `VGUI_CursorSelect'::`1'::__LINE__Var
_DATA	ENDS
...
; File D:\DevDragon\XashFE\dev\src\engine\client\vgui\vgui_input.cpp
;	COMDAT ?VGUI_MapKey@@YA?AW4KeyCode@vgui@@H@Z
_TEXT	SEGMENT
_keyCode$ = 8						; size = 4
?VGUI_MapKey@@YA?AW4KeyCode@vgui@@H@Z PROC		; VGUI_MapKey, COMDAT
...
; 218  : 	VGUI_InitKeyTranslationTable();

	call	?VGUI_InitKeyTranslationTable@@YAXXZ	; VGUI_InitKeyTranslationTable

; 219  : 
; 220  : 	if( keyCode < 0 || keyCode >= ARRAYSIZE( s_pVirtualKeyTrans ))

	cmp	DWORD PTR _keyCode$[ebp], 0
	jl	SHORT $LN4@VGUI_MapKe
	cmp	DWORD PTR _keyCode$[ebp], 256		; 00000100H
	jb	SHORT $LN2@VGUI_MapKe
$LN4@VGUI_MapKe:
...
; 222  : 		Assert( 0 );
	...
	push	0
	mov	eax, DWORD PTR ?__LINE__Var@?0??VGUI_MapKey@@YA?AW4KeyCode@vgui@@H@Z@4JA
	add	eax, 5
	push	eax
	push	OFFSET ??_C@_0DO@BHDILELM@D?3?2DevDragon?2XashFE?2dev?2src?2eng@
	push	OFFSET ??_C@_01GBGANLPD@0@
	push	0
	call	_DBG_AssertFunction
	add	esp, 20					; 00000014H

; 223  : 		return (KeyCode)-1;

	or	eax, -1
	jmp	SHORT $LN1@VGUI_MapKe
...
; 225  : 	else
; 226  : 	{
; 227  : 		return s_pVirtualKeyTrans[keyCode];

	mov	eax, DWORD PTR _keyCode$[ebp]
	mov	eax, DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax*4]
$LN1@VGUI_MapKe:
...
; 229  : }
	...
	pop	ebp
	ret	0
?VGUI_MapKey@@YA?AW4KeyCode@vgui@@H@Z ENDP		; VGUI_MapKey
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File D:\DevDragon\XashFE\dev\src\engine\client\vgui\vgui_input.cpp
;	COMDAT ?VGUI_InitKeyTranslationTable@@YAXXZ
_TEXT	SEGMENT
?VGUI_InitKeyTranslationTable@@YAXXZ PROC		; VGUI_InitKeyTranslationTable, COMDAT
...
; 103  : 	static bool bInitted = false;
; 104  : 
; 105  : 	if( bInitted ) return;

	movzx	eax, BYTE PTR ?bInitted@?1??VGUI_InitKeyTranslationTable@@YAXXZ@4_NA
	test	eax, eax
	je	SHORT $LN2@VGUI_InitK
	jmp	$LN1@VGUI_InitK
$LN2@VGUI_InitK:

; 106  : 	bInitted = true;

	mov	BYTE PTR ?bInitted@?1??VGUI_InitKeyTranslationTable@@YAXXZ@4_NA, 1

; 107  : 
; 108  : 	// set virtual key translation table
; 109  : 	memset( s_pVirtualKeyTrans, -1, sizeof( s_pVirtualKeyTrans ));	

	push	1024					; 00000400H
	push	-1
	push	OFFSET ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A
	call	_memset
	add	esp, 12					; 0000000cH

; 110  : 
; 111  : 	s_pVirtualKeyTrans['0'] = KEY_0;

	mov	eax, 4
	imul	ecx, eax, 48
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 0

; 112  : 	s_pVirtualKeyTrans['1'] = KEY_1;

	mov	eax, 4
	imul	ecx, eax, 49
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 1

; 113  : 	s_pVirtualKeyTrans['2'] = KEY_2;

	mov	eax, 4
	imul	ecx, eax, 50
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 2

; 114  : 	s_pVirtualKeyTrans['3'] = KEY_3;

	mov	eax, 4
	imul	ecx, eax, 51
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 3

; 115  : 	s_pVirtualKeyTrans['4'] = KEY_4;

	mov	eax, 4
	imul	ecx, eax, 52
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 4

; 116  : 	s_pVirtualKeyTrans['5'] = KEY_5;

	mov	eax, 4
	imul	ecx, eax, 53
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 5

; 117  : 	s_pVirtualKeyTrans['6'] = KEY_6;

	mov	eax, 4
	imul	ecx, eax, 54
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 6

; 118  : 	s_pVirtualKeyTrans['7'] = KEY_7;

	mov	eax, 4
	imul	ecx, eax, 55
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 7

; 119  : 	s_pVirtualKeyTrans['8'] = KEY_8;

	mov	eax, 4
	imul	ecx, eax, 56
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 8

; 120  : 	s_pVirtualKeyTrans['9'] = KEY_9;

	mov	eax, 4
	imul	ecx, eax, 57
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 9

; 121  : 	s_pVirtualKeyTrans['A'] = s_pVirtualKeyTrans['a'] = KEY_A;

	mov	eax, 4
	imul	ecx, eax, 97
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 10 ; 0000000aH
	mov	edx, 4
	imul	eax, edx, 65
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 10 ; 0000000aH

; 122  : 	s_pVirtualKeyTrans['B'] = s_pVirtualKeyTrans['b'] = KEY_B;

	mov	eax, 4
	imul	ecx, eax, 98
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 11 ; 0000000bH
	mov	edx, 4
	imul	eax, edx, 66
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 11 ; 0000000bH

; 123  : 	s_pVirtualKeyTrans['C'] = s_pVirtualKeyTrans['c'] = KEY_C;

	mov	eax, 4
	imul	ecx, eax, 99
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 12 ; 0000000cH
	mov	edx, 4
	imul	eax, edx, 67
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 12 ; 0000000cH

; 124  : 	s_pVirtualKeyTrans['D'] = s_pVirtualKeyTrans['d'] = KEY_D;

	mov	eax, 4
	imul	ecx, eax, 100
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 13 ; 0000000dH
	mov	edx, 4
	imul	eax, edx, 68
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 13 ; 0000000dH

; 125  : 	s_pVirtualKeyTrans['E'] = s_pVirtualKeyTrans['e'] = KEY_E;

	mov	eax, 4
	imul	ecx, eax, 101
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 14 ; 0000000eH
	mov	edx, 4
	imul	eax, edx, 69
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 14 ; 0000000eH

; 126  : 	s_pVirtualKeyTrans['F'] = s_pVirtualKeyTrans['f'] = KEY_F;

	mov	eax, 4
	imul	ecx, eax, 102
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 15 ; 0000000fH
	mov	edx, 4
	imul	eax, edx, 70
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 15 ; 0000000fH

; 127  : 	s_pVirtualKeyTrans['G'] = s_pVirtualKeyTrans['g'] = KEY_G;

	mov	eax, 4
	imul	ecx, eax, 103
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 16 ; 00000010H
	mov	edx, 4
	imul	eax, edx, 71
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 16 ; 00000010H

; 128  : 	s_pVirtualKeyTrans['H'] = s_pVirtualKeyTrans['h'] = KEY_H;

	mov	eax, 4
	imul	ecx, eax, 104
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 17 ; 00000011H
	mov	edx, 4
	imul	eax, edx, 72
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 17 ; 00000011H

; 129  : 	s_pVirtualKeyTrans['I'] = s_pVirtualKeyTrans['i'] = KEY_I;

	mov	eax, 4
	imul	ecx, eax, 105
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 18 ; 00000012H
	mov	edx, 4
	imul	eax, edx, 73
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 18 ; 00000012H

; 130  : 	s_pVirtualKeyTrans['J'] = s_pVirtualKeyTrans['j'] = KEY_J;

	mov	eax, 4
	imul	ecx, eax, 106
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 19 ; 00000013H
	mov	edx, 4
	imul	eax, edx, 74
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 19 ; 00000013H

; 131  : 	s_pVirtualKeyTrans['K'] = s_pVirtualKeyTrans['k'] = KEY_K;

	mov	eax, 4
	imul	ecx, eax, 107
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 20 ; 00000014H
	mov	edx, 4
	imul	eax, edx, 75
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 20 ; 00000014H

; 132  : 	s_pVirtualKeyTrans['L'] = s_pVirtualKeyTrans['l'] = KEY_L;

	mov	eax, 4
	imul	ecx, eax, 108
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 21 ; 00000015H
	mov	edx, 4
	imul	eax, edx, 76
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 21 ; 00000015H

; 133  : 	s_pVirtualKeyTrans['M'] = s_pVirtualKeyTrans['m'] = KEY_M;

	mov	eax, 4
	imul	ecx, eax, 109
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 22 ; 00000016H
	mov	edx, 4
	imul	eax, edx, 77
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 22 ; 00000016H

; 134  : 	s_pVirtualKeyTrans['N'] = s_pVirtualKeyTrans['n'] = KEY_N;

	mov	eax, 4
	imul	ecx, eax, 110
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 23 ; 00000017H
	mov	edx, 4
	imul	eax, edx, 78
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 23 ; 00000017H

; 135  : 	s_pVirtualKeyTrans['O'] = s_pVirtualKeyTrans['o'] = KEY_O;

	mov	eax, 4
	imul	ecx, eax, 111
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 24 ; 00000018H
	mov	edx, 4
	imul	eax, edx, 79
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 24 ; 00000018H

; 136  : 	s_pVirtualKeyTrans['P'] = s_pVirtualKeyTrans['p'] = KEY_P;

	mov	eax, 4
	imul	ecx, eax, 112
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 25 ; 00000019H
	mov	edx, 4
	imul	eax, edx, 80
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 25 ; 00000019H

; 137  : 	s_pVirtualKeyTrans['Q'] = s_pVirtualKeyTrans['q'] = KEY_Q;

	mov	eax, 4
	imul	ecx, eax, 113
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 26 ; 0000001aH
	mov	edx, 4
	imul	eax, edx, 81
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 26 ; 0000001aH

; 138  : 	s_pVirtualKeyTrans['R'] = s_pVirtualKeyTrans['r'] = KEY_R;

	mov	eax, 4
	imul	ecx, eax, 114
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 27 ; 0000001bH
	mov	edx, 4
	imul	eax, edx, 82
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 27 ; 0000001bH

; 139  : 	s_pVirtualKeyTrans['S'] = s_pVirtualKeyTrans['s'] = KEY_S;

	mov	eax, 4
	imul	ecx, eax, 115
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 28 ; 0000001cH
	mov	edx, 4
	imul	eax, edx, 83
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 28 ; 0000001cH

; 140  : 	s_pVirtualKeyTrans['T'] = s_pVirtualKeyTrans['t'] = KEY_T;

	mov	eax, 4
	imul	ecx, eax, 116
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 29 ; 0000001dH
	mov	edx, 4
	imul	eax, edx, 84
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 29 ; 0000001dH

; 141  : 	s_pVirtualKeyTrans['U'] = s_pVirtualKeyTrans['u'] = KEY_U;

	mov	eax, 4
	imul	ecx, eax, 117
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 30 ; 0000001eH
	mov	edx, 4
	imul	eax, edx, 85
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 30 ; 0000001eH

; 142  : 	s_pVirtualKeyTrans['V'] = s_pVirtualKeyTrans['v'] = KEY_V;

	mov	eax, 4
	imul	ecx, eax, 118
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 31 ; 0000001fH
	mov	edx, 4
	imul	eax, edx, 86
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 31 ; 0000001fH

; 143  : 	s_pVirtualKeyTrans['W'] = s_pVirtualKeyTrans['w'] = KEY_W;

	mov	eax, 4
	imul	ecx, eax, 119
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 32 ; 00000020H
	mov	edx, 4
	imul	eax, edx, 87
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 32 ; 00000020H

; 144  : 	s_pVirtualKeyTrans['X'] = s_pVirtualKeyTrans['x'] = KEY_X;

	mov	eax, 4
	imul	ecx, eax, 120
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 33 ; 00000021H
	mov	edx, 4
	imul	eax, edx, 88
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 33 ; 00000021H

; 145  : 	s_pVirtualKeyTrans['Y'] = s_pVirtualKeyTrans['y'] = KEY_Y;

	mov	eax, 4
	imul	ecx, eax, 121
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 34 ; 00000022H
	mov	edx, 4
	imul	eax, edx, 89
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 34 ; 00000022H

; 146  : 	s_pVirtualKeyTrans['Z'] = s_pVirtualKeyTrans['z'] = KEY_Z;

	mov	eax, 4
	imul	ecx, eax, 122
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 35 ; 00000023H
	mov	edx, 4
	imul	eax, edx, 90
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 35 ; 00000023H

; 147  : 	s_pVirtualKeyTrans[VK_NUMPAD0] = KEY_PAD_0;

	mov	eax, 4
	imul	ecx, eax, 96
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 36 ; 00000024H

; 148  : 	s_pVirtualKeyTrans[VK_NUMPAD1] = KEY_PAD_1;

	mov	eax, 4
	imul	ecx, eax, 97
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 37 ; 00000025H

; 149  : 	s_pVirtualKeyTrans[VK_NUMPAD2] = KEY_PAD_2;

	mov	eax, 4
	imul	ecx, eax, 98
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 38 ; 00000026H

; 150  : 	s_pVirtualKeyTrans[VK_NUMPAD3] = KEY_PAD_3;

	mov	eax, 4
	imul	ecx, eax, 99
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 39 ; 00000027H

; 151  : 	s_pVirtualKeyTrans[VK_NUMPAD4] = KEY_PAD_4;

	mov	eax, 4
	imul	ecx, eax, 100
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 40 ; 00000028H

; 152  : 	s_pVirtualKeyTrans[VK_NUMPAD5] = KEY_PAD_5;

	mov	eax, 4
	imul	ecx, eax, 101
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 41 ; 00000029H

; 153  : 	s_pVirtualKeyTrans[VK_NUMPAD6] = KEY_PAD_6;

	mov	eax, 4
	imul	ecx, eax, 102
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 42 ; 0000002aH

; 154  : 	s_pVirtualKeyTrans[VK_NUMPAD7] = KEY_PAD_7;

	mov	eax, 4
	imul	ecx, eax, 103
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 43 ; 0000002bH

; 155  : 	s_pVirtualKeyTrans[VK_NUMPAD8] = KEY_PAD_8;

	mov	eax, 4
	imul	ecx, eax, 104
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 44 ; 0000002cH

; 156  : 	s_pVirtualKeyTrans[VK_NUMPAD9] = KEY_PAD_9;

	mov	eax, 4
	imul	ecx, eax, 105
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 45 ; 0000002dH

; 157  : 	s_pVirtualKeyTrans[VK_DIVIDE]	= KEY_PAD_DIVIDE;

	mov	eax, 4
	imul	ecx, eax, 111
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 46 ; 0000002eH

; 158  : 	s_pVirtualKeyTrans[VK_MULTIPLY] = KEY_PAD_MULTIPLY;

	mov	eax, 4
	imul	ecx, eax, 106
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 47 ; 0000002fH

; 159  : 	s_pVirtualKeyTrans[VK_SUBTRACT] = KEY_PAD_MINUS;

	mov	eax, 4
	imul	ecx, eax, 109
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 48 ; 00000030H

; 160  : 	s_pVirtualKeyTrans[VK_ADD] = KEY_PAD_PLUS;

	mov	eax, 4
	imul	ecx, eax, 107
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 49 ; 00000031H

; 161  : 	s_pVirtualKeyTrans[VK_RETURN]	= KEY_PAD_ENTER;

	mov	eax, 4
	imul	ecx, eax, 13
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 50 ; 00000032H

; 162  : 	s_pVirtualKeyTrans[VK_DECIMAL] = KEY_PAD_DECIMAL;

	mov	eax, 4
	imul	ecx, eax, 110
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 51 ; 00000033H

; 163  : 	s_pVirtualKeyTrans[0xdb] = KEY_LBRACKET;

	mov	eax, 4
	imul	ecx, eax, 219
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 52 ; 00000034H

; 164  : 	s_pVirtualKeyTrans[0xdd] = KEY_RBRACKET;

	mov	eax, 4
	imul	ecx, eax, 221
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 53 ; 00000035H

; 165  : 	s_pVirtualKeyTrans[0xba] = KEY_SEMICOLON;

	mov	eax, 4
	imul	ecx, eax, 186
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 54 ; 00000036H

; 166  : 	s_pVirtualKeyTrans[0xde] = KEY_APOSTROPHE;

	mov	eax, 4
	imul	ecx, eax, 222
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 55 ; 00000037H

; 167  : 	s_pVirtualKeyTrans[0xc0] = KEY_BACKQUOTE;

	mov	eax, 4
	imul	ecx, eax, 192
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 56 ; 00000038H

; 168  : 	s_pVirtualKeyTrans[0xbc] = KEY_COMMA;

	mov	eax, 4
	imul	ecx, eax, 188
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 57 ; 00000039H

; 169  : 	s_pVirtualKeyTrans[0xbe] = KEY_PERIOD;

	mov	eax, 4
	imul	ecx, eax, 190
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 58 ; 0000003aH

; 170  : 	s_pVirtualKeyTrans[0xbf] = KEY_SLASH;

	mov	eax, 4
	imul	ecx, eax, 191
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 59 ; 0000003bH

; 171  : 	s_pVirtualKeyTrans[0xdc] = KEY_BACKSLASH;

	mov	eax, 4
	imul	ecx, eax, 220
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 60 ; 0000003cH

; 172  : 	s_pVirtualKeyTrans[0xbd] = KEY_MINUS;

	mov	eax, 4
	imul	ecx, eax, 189
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 61 ; 0000003dH

; 173  : 	s_pVirtualKeyTrans[0xbb] = KEY_EQUAL;

	mov	eax, 4
	imul	ecx, eax, 187
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 62 ; 0000003eH

; 174  : 	s_pVirtualKeyTrans[VK_RETURN]	= KEY_ENTER;

	mov	eax, 4
	imul	ecx, eax, 13
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 63 ; 0000003fH

; 175  : 	s_pVirtualKeyTrans[VK_SPACE] = KEY_SPACE;

	mov	eax, 4
	shl	eax, 5
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 64 ; 00000040H

; 176  : 	s_pVirtualKeyTrans[VK_BACK] = KEY_BACKSPACE;

	mov	eax, 4
	shl	eax, 3
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 65 ; 00000041H

; 177  : 	s_pVirtualKeyTrans[VK_TAB] = KEY_TAB;

	mov	eax, 4
	imul	ecx, eax, 9
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 66 ; 00000042H

; 178  : 	s_pVirtualKeyTrans[VK_CAPITAL] = KEY_CAPSLOCK;

	mov	eax, 4
	imul	ecx, eax, 20
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 67 ; 00000043H

; 179  : 	s_pVirtualKeyTrans[VK_NUMLOCK] = KEY_NUMLOCK;

	mov	eax, 4
	imul	ecx, eax, 144
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 68 ; 00000044H

; 180  : 	s_pVirtualKeyTrans[VK_ESCAPE]	= KEY_ESCAPE;

	mov	eax, 4
	imul	ecx, eax, 27
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 69 ; 00000045H

; 181  : 	s_pVirtualKeyTrans[VK_SCROLL]	= KEY_SCROLLLOCK;

	mov	eax, 4
	imul	ecx, eax, 145
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 70 ; 00000046H

; 182  : 	s_pVirtualKeyTrans[VK_INSERT]	= KEY_INSERT;

	mov	eax, 4
	imul	ecx, eax, 45
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 71 ; 00000047H

; 183  : 	s_pVirtualKeyTrans[VK_DELETE]	= KEY_DELETE;

	mov	eax, 4
	imul	ecx, eax, 46
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 72 ; 00000048H

; 184  : 	s_pVirtualKeyTrans[VK_HOME] = KEY_HOME;

	mov	eax, 4
	imul	ecx, eax, 36
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 73 ; 00000049H

; 185  : 	s_pVirtualKeyTrans[VK_END] = KEY_END;

	mov	eax, 4
	imul	ecx, eax, 35
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 74 ; 0000004aH

; 186  : 	s_pVirtualKeyTrans[VK_PRIOR] = KEY_PAGEUP;

	mov	eax, 4
	imul	ecx, eax, 33
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 75 ; 0000004bH

; 187  : 	s_pVirtualKeyTrans[VK_NEXT] = KEY_PAGEDOWN;

	mov	eax, 4
	imul	ecx, eax, 34
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 76 ; 0000004cH

; 188  : 	s_pVirtualKeyTrans[VK_PAUSE] = KEY_BREAK;

	mov	eax, 4
	imul	ecx, eax, 19
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 77 ; 0000004dH

; 189  : 	s_pVirtualKeyTrans[VK_SHIFT] = KEY_RSHIFT;

	mov	eax, 4
	shl	eax, 4
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 79 ; 0000004fH

; 190  : 	s_pVirtualKeyTrans[VK_SHIFT] = KEY_LSHIFT;	// SHIFT -> left SHIFT

	mov	eax, 4
	shl	eax, 4
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[eax], 78 ; 0000004eH

; 191  : 	s_pVirtualKeyTrans[VK_MENU] = KEY_RALT;

	mov	eax, 4
	imul	ecx, eax, 18
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 81 ; 00000051H

; 192  : 	s_pVirtualKeyTrans[VK_MENU] = KEY_LALT;		// ALT -> left ALT

	mov	eax, 4
	imul	ecx, eax, 18
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 80 ; 00000050H

; 193  : 	s_pVirtualKeyTrans[VK_CONTROL] = KEY_RCONTROL;

	mov	eax, 4
	imul	ecx, eax, 17
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 83 ; 00000053H

; 194  : 	s_pVirtualKeyTrans[VK_CONTROL] = KEY_LCONTROL;	// CTRL -> left CTRL

	mov	eax, 4
	imul	ecx, eax, 17
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 82 ; 00000052H

; 195  : 	s_pVirtualKeyTrans[VK_LWIN] = KEY_LWIN;

	mov	eax, 4
	imul	ecx, eax, 91
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 84 ; 00000054H

; 196  : 	s_pVirtualKeyTrans[VK_RWIN] = KEY_RWIN;

	mov	eax, 4
	imul	ecx, eax, 92
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 85 ; 00000055H

; 197  : 	s_pVirtualKeyTrans[VK_APPS] = KEY_APP;

	mov	eax, 4
	imul	ecx, eax, 93
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 86 ; 00000056H

; 198  : 	s_pVirtualKeyTrans[VK_UP] = KEY_UP;

	mov	eax, 4
	imul	ecx, eax, 38
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 87 ; 00000057H

; 199  : 	s_pVirtualKeyTrans[VK_LEFT] = KEY_LEFT;

	mov	eax, 4
	imul	ecx, eax, 37
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 88 ; 00000058H

; 200  : 	s_pVirtualKeyTrans[VK_DOWN] = KEY_DOWN;

	mov	eax, 4
	imul	ecx, eax, 40
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 89 ; 00000059H

; 201  : 	s_pVirtualKeyTrans[VK_RIGHT] = KEY_RIGHT;	

	mov	eax, 4
	imul	ecx, eax, 39
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 90 ; 0000005aH

; 202  : 	s_pVirtualKeyTrans[VK_F1] = KEY_F1;

	mov	eax, 4
	imul	ecx, eax, 112
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 91 ; 0000005bH

; 203  : 	s_pVirtualKeyTrans[VK_F2] = KEY_F2;

	mov	eax, 4
	imul	ecx, eax, 113
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 92 ; 0000005cH

; 204  : 	s_pVirtualKeyTrans[VK_F3] = KEY_F3;

	mov	eax, 4
	imul	ecx, eax, 114
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 93 ; 0000005dH

; 205  : 	s_pVirtualKeyTrans[VK_F4] = KEY_F4;

	mov	eax, 4
	imul	ecx, eax, 115
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 94 ; 0000005eH

; 206  : 	s_pVirtualKeyTrans[VK_F5] = KEY_F5;

	mov	eax, 4
	imul	ecx, eax, 116
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 95 ; 0000005fH

; 207  : 	s_pVirtualKeyTrans[VK_F6] = KEY_F6;

	mov	eax, 4
	imul	ecx, eax, 117
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 96 ; 00000060H

; 208  : 	s_pVirtualKeyTrans[VK_F7] = KEY_F7;

	mov	eax, 4
	imul	ecx, eax, 118
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 97 ; 00000061H

; 209  : 	s_pVirtualKeyTrans[VK_F8] = KEY_F8;

	mov	eax, 4
	imul	ecx, eax, 119
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 98 ; 00000062H

; 210  : 	s_pVirtualKeyTrans[VK_F9] = KEY_F9;

	mov	eax, 4
	imul	ecx, eax, 120
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 99 ; 00000063H

; 211  : 	s_pVirtualKeyTrans[VK_F10] = KEY_F10;

	mov	eax, 4
	imul	ecx, eax, 121
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 100 ; 00000064H

; 212  : 	s_pVirtualKeyTrans[VK_F11] = KEY_F11;

	mov	eax, 4
	imul	ecx, eax, 122
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 101 ; 00000065H

; 213  : 	s_pVirtualKeyTrans[VK_F12] = KEY_F12;

	mov	eax, 4
	imul	ecx, eax, 123
	mov	DWORD PTR ?s_pVirtualKeyTrans@@3PAW4KeyCode@vgui@@A[ecx], 102 ; 00000066H
$LN1@VGUI_InitK:
...
; 214  : }
	...
	pop	ebp
	ret	0
?VGUI_InitKeyTranslationTable@@YAXXZ ENDP		; VGUI_InitKeyTranslationTable
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File D:\DevDragon\XashFE\dev\src\engine\client\vgui\vgui_input.cpp
;	COMDAT ?VGUI_ActivateCurrentCursor@@YAXXZ
_TEXT	SEGMENT
?VGUI_ActivateCurrentCursor@@YAXXZ PROC			; VGUI_ActivateCurrentCursor, COMDAT
...
; 86   : 	if( cls.key_dest != key_game || cl.paused )

	cmp	DWORD PTR _cls+36, 1
	jne	SHORT $LN7@VGUI_Activ
	cmp	DWORD PTR _cl+24, 0
	je	SHORT $LN6@VGUI_Activ
$LN7@VGUI_Activ:

; 87   : 		return;

	jmp	SHORT $LN1@VGUI_Activ
$LN6@VGUI_Activ:

; 88   : 
; 89   : 	if( host.mouse_visible )

	cmp	DWORD PTR _host+34372, 0
	je	SHORT $LN4@VGUI_Activ
$LN2@VGUI_Activ:

; 90   : 	{
; 91   : 		while( ShowCursor( true ) < 0 );

	push	1
	call	DWORD PTR __imp__ShowCursor@4
	test	eax, eax
	jge	SHORT $LN3@VGUI_Activ
	jmp	SHORT $LN2@VGUI_Activ
$LN3@VGUI_Activ:

; 92   : 		SetCursor( s_hCurrentCursor );

	mov	eax, DWORD PTR ?s_hCurrentCursor@@3PAUHICON__@@A
	push	eax
...
; 94   : 	else
; 95   : 	{
; 96   : 		while( ShowCursor( false ) >= 0 );

	push	0
	call	DWORD PTR __imp__ShowCursor@4
	test	eax, eax
	jl	SHORT $LN5@VGUI_Activ
	jmp	SHORT $LN4@VGUI_Activ
$LN5@VGUI_Activ:
...
; 99   : }
	...
	pop	ebp
	ret	0
?VGUI_ActivateCurrentCursor@@YAXXZ ENDP			; VGUI_ActivateCurrentCursor
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File D:\DevDragon\XashFE\dev\src\engine\client\vgui\vgui_input.cpp
;	COMDAT ?VGUI_CursorSelect@@YAXPAVCursor@vgui@@@Z
_TEXT	SEGMENT
tv76 = -68						; size = 4
tv70 = -68						; size = 4
_cursor$ = 8						; size = 4
?VGUI_CursorSelect@@YAXPAVCursor@vgui@@@Z PROC		; VGUI_CursorSelect, COMDAT
...
; 51   : 	Assert( cursor != NULL );

	cmp	DWORD PTR _cursor$[ebp], 0
	je	SHORT $LN20@VGUI_Curso
	mov	DWORD PTR tv70[ebp], 1
	jmp	SHORT $LN21@VGUI_Curso
$LN20@VGUI_Curso:
	mov	DWORD PTR tv70[ebp], 0
$LN21@VGUI_Curso:
	push	0
	mov	eax, DWORD PTR ?__LINE__Var@?0??VGUI_CursorSelect@@YAXPAVCursor@vgui@@@Z@4JA
	add	eax, 1
	push	eax
	push	OFFSET ??_C@_0DO@BHDILELM@D?3?2DevDragon?2XashFE?2dev?2src?2eng@
	push	OFFSET ??_C@_0P@OKCGOPOA@cursor?5?$CB?$DN?5NULL@
...
; 52   : 
; 53   : 	host.mouse_visible = true;

	mov	DWORD PTR _host+34372, 1

; 54   : 
; 55   : 	switch( cursor->getDefaultCursor( ))
	...
	ja	SHORT $LN18@VGUI_Curso
	mov	ecx, DWORD PTR tv76[ebp]
	jmp	DWORD PTR $LN22@VGUI_Curso[ecx*4]
$LN5@VGUI_Curso:

; 56   : 	{
; 57   : 	case Cursor::dc_user:
; 58   : 	case Cursor::dc_none:
; 59   : 		host.mouse_visible = false;

	mov	DWORD PTR _host+34372, 0

; 60   : 		break;

	jmp	SHORT $LN2@VGUI_Curso
$LN17@VGUI_Curso:

; 61   : 	case Cursor::dc_arrow:
; 62   : 	case Cursor::dc_ibeam:
; 63   : 	case Cursor::dc_hourglass:
; 64   : 	case Cursor::dc_crosshair:
; 65   : 	case Cursor::dc_up:
; 66   : 	case Cursor::dc_sizenwse:
; 67   : 	case Cursor::dc_sizenesw:
; 68   : 	case Cursor::dc_sizewe:
; 69   : 	case Cursor::dc_sizens:
; 70   : 	case Cursor::dc_sizeall:
; 71   : 	case Cursor::dc_no:
; 72   : 	case Cursor::dc_hand:
; 73   : 		s_hCurrentCursor = s_pDefaultCursor[cursor->getDefaultCursor()];
	...
	mov	eax, DWORD PTR [edx+12]
	call	eax
	mov	ecx, DWORD PTR ?s_pDefaultCursor@@3PAPAUHICON__@@A[eax*4]
	mov	DWORD PTR ?s_hCurrentCursor@@3PAUHICON__@@A, ecx
...
; 79   : 	}
; 80   : 
; 81   : 	VGUI_ActivateCurrentCursor();

	call	?VGUI_ActivateCurrentCursor@@YAXXZ	; VGUI_ActivateCurrentCursor
...
$LN22@VGUI_Curso:
	...
	DD	$LN17@VGUI_Curso
	DD	$LN17@VGUI_Curso
?VGUI_CursorSelect@@YAXPAVCursor@vgui@@@Z ENDP		; VGUI_CursorSelect
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
; File D:\DevDragon\XashFE\dev\src\engine\client\vgui\vgui_input.cpp
;	COMDAT ?VGUI_InitCursors@@YAXXZ
_TEXT	SEGMENT
?VGUI_InitCursors@@YAXXZ PROC				; VGUI_InitCursors, COMDAT
...
; 30   : 	// load up all default cursors
; 31   : 	s_pDefaultCursor[Cursor::dc_none]     = NULL;

	mov	eax, 4
	shl	eax, 0
	mov	DWORD PTR ?s_pDefaultCursor@@3PAPAUHICON__@@A[eax], 0

; 32   : 	s_pDefaultCursor[Cursor::dc_arrow]    = (HICON)LoadCursor( NULL, (LPCTSTR)OCR_NORMAL );
	...
	mov	ecx, 4
	shl	ecx, 1
	mov	DWORD PTR ?s_pDefaultCursor@@3PAPAUHICON__@@A[ecx], eax

; 33   : 	s_pDefaultCursor[Cursor::dc_ibeam]    = (HICON)LoadCursor( NULL, (LPCTSTR)OCR_IBEAM );
	...
	mov	ecx, 4
	imul	edx, ecx, 3
	mov	DWORD PTR ?s_pDefaultCursor@@3PAPAUHICON__@@A[edx], eax

; 34   : 	s_pDefaultCursor[Cursor::dc_hourglass]= (HICON)LoadCursor( NULL, (LPCTSTR)OCR_WAIT );
...
; 35   : 	s_pDefaultCursor[Cursor::dc_crosshair]= (HICON)LoadCursor( NULL, (LPCTSTR)OCR_CROSS );
...
; 36   : 	s_pDefaultCursor[Cursor::dc_up]       = (HICON)LoadCursor( NULL, (LPCTSTR)OCR_UP );

	push	32516					; 00007f04H
	push	0
	call	DWORD PTR __imp__LoadCursorA@8
	mov	ecx, 4
	imul	edx, ecx, 6
...
; 37   : 	s_pDefaultCursor[Cursor::dc_sizenwse] = (HICON)LoadCursor( NULL, (LPCTSTR)OCR_SIZENWSE );
...
; 38   : 	s_pDefaultCursor[Cursor::dc_sizenesw] = (HICON)LoadCursor( NULL, (LPCTSTR)OCR_SIZENESW );
...
; 39   : 	s_pDefaultCursor[Cursor::dc_sizewe]   = (HICON)LoadCursor( NULL, (LPCTSTR)OCR_SIZEWE );
...
; 40   : 	s_pDefaultCursor[Cursor::dc_sizens]   = (HICON)LoadCursor( NULL, (LPCTSTR)OCR_SIZENS );
...
; 41   : 	s_pDefaultCursor[Cursor::dc_sizeall]  = (HICON)LoadCursor( NULL, (LPCTSTR)OCR_SIZEALL );

	push	32646					; 00007f86H
	push	0
	call	DWORD PTR __imp__LoadCursorA@8
	mov	ecx, 4
	imul	edx, ecx, 11
...
; 42   : 	s_pDefaultCursor[Cursor::dc_no]       = (HICON)LoadCursor( NULL, (LPCTSTR)OCR_NO );

	push	32648					; 00007f88H
	push	0
	call	DWORD PTR __imp__LoadCursorA@8
	mov	ecx, 4
	imul	edx, ecx, 12
...
; 43   : 	s_pDefaultCursor[Cursor::dc_hand]     = (HICON)LoadCursor( NULL, (LPCTSTR)32649 );
...
; 44   : 
; 45   : 	s_hCurrentCursor = s_pDefaultCursor[Cursor::dc_arrow];

	mov	eax, 4
	shl	eax, 1
	mov	ecx, DWORD PTR ?s_pDefaultCursor@@3PAPAUHICON__@@A[eax]
	mov	DWORD PTR ?s_hCurrentCursor@@3PAUHICON__@@A, ecx

; 46   : 	host.mouse_visible = true;
...
; 47   : }
	...
	pop	ebp
	ret	0
?VGUI_InitCursors@@YAXXZ ENDP				; VGUI_InitCursors
_TEXT	ENDS
; Function compile flags: /Odtp /ZI
...
_wParam$ = 16						; size = 4
_lParam$ = 20						; size = 4
_VGUI_SurfaceWndProc PROC				; COMDAT
...
; 233  : 	if( !engSurface )
	...
	cmp	DWORD PTR ?engSurface@@3PAVCEngineSurface@@A, 0 ; engSurface
	jne	SHORT $LN4@VGUI_Surfa
...
; 236  : 	switch( uMsg )
	...
	ja	SHORT $LN25@VGUI_Surfa
	cmp	DWORD PTR tv65[ebp], 512		; 00000200H
	je	SHORT $LN6@VGUI_Surfa
	...
	movzx	eax, BYTE PTR $LN26@VGUI_Surfa[edx]
	jmp	DWORD PTR $LN27@VGUI_Surfa[eax*4]
$LN25@VGUI_Surfa:
	mov	ecx, DWORD PTR tv65[ebp]
	...
	ja	$LN2@VGUI_Surfa
	mov	edx, DWORD PTR tv65[ebp]
	jmp	DWORD PTR $LN28@VGUI_Surfa[edx*4]
$LN5@VGUI_Surfa:

; 237  : 	{
; 238  : 	case WM_SETCURSOR:
; 239  : 		VGUI_ActivateCurrentCursor();
...
; 242  : 		engApp->internalCursorMoved((short)LOWORD( lParam ), (short)HIWORD( lParam ), engSurface );

	mov	eax, DWORD PTR ?engSurface@@3PAVCEngineSurface@@A ; engSurface
	push	eax
	...
	movsx	ecx, ax
	push	ecx
	mov	edx, DWORD PTR ?engApp@@3PAVCEngineApp@@A ; engApp
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR ?engApp@@3PAVCEngineApp@@A ; engApp
...
; 245  : 		engApp->internalMousePressed( MOUSE_LEFT, engSurface );
...
; 248  : 		engApp->internalMousePressed( MOUSE_RIGHT, engSurface );
...
; 251  : 		engApp->internalMousePressed( MOUSE_MIDDLE, engSurface );
...
; 254  : 		engApp->internalMouseReleased( MOUSE_LEFT, engSurface );
...
; 257  : 		engApp->internalMouseReleased( MOUSE_RIGHT, engSurface );
...
; 260  : 		engApp->internalMouseReleased( MOUSE_MIDDLE, engSurface );
...
; 263  : 		engApp->internalMouseDoublePressed( MOUSE_LEFT, engSurface );
...
; 266  : 		engApp->internalMouseDoublePressed( MOUSE_RIGHT, engSurface );
...
; 268  : 	case WM_MBUTTONDBLCLK:
; 269  : 		engApp->internalMouseDoublePressed( MOUSE_MIDDLE, engSurface );
...
; 272  : 		engApp->internalMouseWheeled(((short)HIWORD( wParam )) / WHEEL_DELTA, engSurface );
...
; 276  : 		if( !FBitSet( lParam, BIT( 30 )))

	mov	eax, DWORD PTR _lParam$[ebp]
	and	eax, 1073741824				; 40000000H
	jne	SHORT $LN19@VGUI_Surfa

; 277  : 			engApp->internalKeyPressed( VGUI_MapKey( wParam ), engSurface );

	mov	eax, DWORD PTR ?engSurface@@3PAVCEngineSurface@@A ; engSurface
	push	eax
	mov	ecx, DWORD PTR _wParam$[ebp]
	push	ecx
	call	?VGUI_MapKey@@YA?AW4KeyCode@vgui@@H@Z	; VGUI_MapKey
	add	esp, 4
	push	eax
	mov	edx, DWORD PTR ?engApp@@3PAVCEngineApp@@A ; engApp
	mov	eax, DWORD PTR [edx]
...
; 278  : 		engApp->internalKeyTyped( VGUI_MapKey( wParam ), engSurface );
...
; 279  : 		break;
	...
	jmp	SHORT $LN2@VGUI_Surfa

; 280  : 	case WM_CHAR:
; 281  : 	case WM_SYSCHAR:
; 282  : 		// already handled in Key_Event
; 283  : 		break;
...
; 286  : 		engApp->internalKeyReleased( VGUI_MapKey( wParam ), engSurface );
